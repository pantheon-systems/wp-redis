...
class WP_Object_Cache {
	...
	function stats() {
		...
		foreach ( $this->cache as $group => $cache ) {
			echo "<li><strong>Group:</strong> $group - ( "
	...
	protected function _connect_redis() {
		...
		if ( file_exists( $redis_server['host'] ) && filetype( $redis_server['host'] ) == 'socket' ) {
		...
		$this->redis->connect( $redis_server['host'], $port, 1, null, 100 );
