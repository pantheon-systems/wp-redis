...
rm -f "$PREPARE_DIR"/wp-content/object-cache.php
cd "$BASH_DIR"/..
...
###
# Add the debugging mu-plugin the test suite samples Redis stats through.
###
rm -f "$PREPARE_DIR"/wp-content/mu-plugins/redis-debug.php
